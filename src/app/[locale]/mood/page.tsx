...
function getMoodConfig(
  ...
  return {
    great: { label: t("moods.great"), icon: Smile, color: moodColors.great.text, emoji: "😄" },
    good: { label: t("moods.good"), icon: Smile, color: moodColors.good.text, emoji: "🙂" },
    okay: { label: t("moods.okay"), icon: Meh, color: moodColors.okay.text, emoji: "😐" },
    bad: { label: t("moods.bad"), icon: Frown, color: moodColors.bad.text, emoji: "😕" },
    terrible: { label: t("moods.terrible"), icon: Frown, color: moodColors.terrible.text, emoji: "😢" },
  }
}
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-4">
                  <div className="text-center">
                    <Battery
                      className={`h-5 w-5 mx-auto mb-1 ${todayMood.energy >= 3 ? "text-[var(--color-success)]" : "text-[var(--color-danger)]"}`}
                    />
